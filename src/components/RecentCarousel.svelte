<script>
  ...
  >
    <h1
      class="mt-4 text-2xl tracking-tight font-extrabold text-{styling.secondaryColor}-900 sm:text-2xl md:text-2xl mb-8 border-b-4 border-{styling.secondaryColor}-800"
    >
  ...
  <Carousel autoplay={30000} perPage={{ 900: 3, 649: 2 }}>
